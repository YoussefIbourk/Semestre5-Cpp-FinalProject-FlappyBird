...
#include <memory>
#include "../../FlappyBird/eletitleboard.h"
...
void EleTitleBoard::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<EleTitleBoard *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject EleTitleBoard::staticMetaObject = { {
    QMetaObject::SuperData::link<GameElement::staticMetaObject>(),
    qt_meta_stringdata_EleTitleBoard.data,
    qt_meta_data_EleTitleBoard,
    qt_static_metacall,
    nullptr,
    nullptr
} };
